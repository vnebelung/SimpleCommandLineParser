...
public class BooleanParameterTest {
    ...
    public void testGetDescription1() {
        InternalParameter<Boolean> parameter = new BooleanParameter("", "testdescription");
        assertEquals(parameter.getDescription(), "testdescription");
    }

    @Test
    public void testGetDescription2() {
        InternalParameter<Boolean> parameter = new BooleanParameter("", "testdescription", true);
        assertEquals(parameter.getDescription(), "testdescription");
    }
    ...
    public void testCopy() {
        InternalParameter<Boolean> parameter = new BooleanParameter("testname", "testdescription", true);
        InternalParameter<Boolean> copy = parameter.copy();
