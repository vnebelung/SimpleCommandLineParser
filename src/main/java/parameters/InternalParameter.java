...
/**
 * This interface represents a parameter that is attached to a (sub)command and is used only for internal purposes.
 */
public interface InternalParameter<T> extends Parameter<T> {
