/*
 * This file is part of ProDisFuzz, modified on 30.10.24, 23:14.
...
public interface ParsedCommand extends ParsedSubcommand {
    ...
    /**
     * Returns the path parameter with the given name that are assigned to this command.
     *
     * @param name the parameter's name
    ...
    /**
     * Returns the double parameter with the given name that are assigned to this command.
     *
     * @param name the parameter's name
